...
const QuizLibrary = ({ studentId, onExit, onRetakeQuiz }) => {
    ...
    const fetchResults = async () => {
        try {
            const res = await fetch(`http://localhost:8000/api/students/${studentId}/results`);
    ...
    if (loading) return <div className="p-8 text-center animate-pulse">Loading quiz history...</div>;
        ...
        <div className="max-w-6xl mx-auto p-6 md:p-10 h-full flex flex-col">
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Review your past performance and retake quizzes</p>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="text-xs font-bold text-purple-500 uppercase tracking-wider">{latestResult.subject}</div>
                                </div>
